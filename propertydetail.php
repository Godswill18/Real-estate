                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                ...
                                <li class="breadcrumb-item active"><a href='landproperty.php'>Land Properties </a></li>
                                <li class="breadcrumb-item active"><a href='houseproperty.php'>House Properties </a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;"> 
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1910" height="1080" src="admin/property/<?php echo $row['16'];?>" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 2-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1910" height="1080" src="admin/property/<?php echo $row['17'];?>" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 3-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1910" height="1080" src="admin/property/<?php echo $row['18'];?>" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 4-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1910" height="1080" src="admin/property/<?php echo $row['19'];?>" class="ls-bg" alt="" /> </div>
									
									<!-- Slide 5-->
									<div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1910" height="1080" src="admin/property/<?php echo $row['20'];?>" class="ls-bg" alt="" /> </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        ...
                                        <a href='tel:+2348079843784' target='blank'>
                                            ...
                                            <button class="call-agent" style='padding: 10px 20px; background-color: #9e9c9c; border: none; border-radius: 5px;' > <i class="fa fa-phone" aria-hidden="true"></i> Call Agent </button>
                                        </a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            $query=mysqli_query($con,"SELECT * FROM `property` WHERE isFeatured = 1 ORDER BY date DESC LIMIT 3");
                                    ...
                                    {
                            ?>
                            <li> <img src="admin/property/<?php echo $row['16'];?>" alt="pimage">
                                ...
                                <span class="font-14"><i class="fas fa-map-marker-alt icon-success icon-small"></i> <?php echo $row['13'];?></span>
