...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO property (title,pcontent,type,stype,price,location,city,state,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,isFeatured,video)
            ...
            <div class="page-wrapper">
                <div class="content container-fluid" style='margin-top: 50px;'>
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">House Property</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active"> House Property</li>
								</ul>
							</div>
						</div>
					</div>
