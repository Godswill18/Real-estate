  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/letonlogo2.png" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/letonlogo2.png" alt="Logo" width="30" height="30">
					</a>
                </div>
				<!-- /Logo -->
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="propertyaddHouse.php"> House Property</a></li>
									<li><a href="propertyaddLand.php"> Land Property</a></li>
