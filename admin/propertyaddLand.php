...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO property (title,pcontent,type,stype,sqmeters,price,location,city,state,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,isFeatured,video)
	VALUES('$title','$content','$ptype','$stype','$sqmeters','$price',
	'$loc','$city','$state','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$isFeatured','$video')";
						...
						<div class="row">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Land Property</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Add Land Property Details</h4>
								</div>
...
<!-- 											
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Neighbor hood</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="nghood" required placeholder="Enter Neighborhood">
													</div>
												</div>
											...
											<div class="col-xl-6">
												<div class="form-group row mb-3">
													<label class="col-lg-3 col-form-label">Square meters</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="sqmeters" required placeholder="Enter Land Square Meters ">
													</div>
												</div>
												<div class="form-group row">
										...
										<!-- <div class="form-group row">
											...
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												...
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Car Park : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">CCTV : </span>Yes</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Water Supply : </span>Ground Water / Tank</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Type : </span>Land</li>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
														...
														<div class="col-lg-9">
															<textarea class="tinymce form-control" name="video" rows="5" cols="5"></textarea>
														</div>
												</div>
												<div class="form-group row">
