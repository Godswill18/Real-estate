                ...
                <!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hover-zoomer bg-white shadow-one mb-4">
                            <div class="overflow-hidden"> <img src="admin/user/ceo2.jpg" alt="aimage"> </div>
                            <div class="py-3 text-center">
                                <h5 class="text-secondary hover-text-success"><a href="#">Tonia Orgor</a></h5>
                                <span>CEO and Agent</span> </div>
                        </div>
                    </div>
