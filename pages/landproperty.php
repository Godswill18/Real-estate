    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Land Properties</b></h2>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-8">
                        ...
                        <?php
                           $query = mysqli_query($con, "SELECT * FROM property WHERE type='land' ORDER BY date DESC");
                            ...
                            <a href="index.php?page=propertydetail&pid=<?php echo $row['0'];?>">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <img src="admin/property/<?php echo $row['16'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">₦<?php echo $row['12'];?> <span class="text-white"><?php echo $row['6'];?> Square Meters</span></div>
