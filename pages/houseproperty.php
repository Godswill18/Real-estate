    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>House Properties</b></h2>
                    </div>
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                <li class="breadcrumb-item text-white"><a href="index.php?page=property">properties</a></li>
                                <li class="breadcrumb-item active">House Properties</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
					...
					<div class="col-lg-8">
                        ...
                        <?php
                           $query = mysqli_query($con, "SELECT * FROM property WHERE type='house' ORDER BY date DESC");
                        ...
                        ?>
                            ...
                            <div class="col-md-6">
                            <a href="index.php?page=propertydetail&pid=<?php echo $row['0'];?>">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative">
                                    
                                
                                    <img src="admin/property/<?php echo $row['16'];?>" alt="pimage">
                                
                                        
                                        <div class="sale bg-success text-white">For <?php echo $row['4'];?></div>
                                        <div class="price text-primary text-capitalize">₦<?php echo $row['12'];?>
                                         <!-- <span class="text-white"><?php echo $row['11'];?> Sqft</span> -->
                                        </div>
                                        
                                    </div>
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="index.php?page=propertydetail&pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
