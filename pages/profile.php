                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone"  class="form-control" placeholder="Enter Phone" maxlength="11">
                                </div>

                                <div class="form-group">
                                    <label for="about-me">Message</label>
                                    <textarea class="form-control" name="content" rows="7" placeholder=""></textarea>
                                </div>
