...
<div id="page-wrapper">
    <div class="row"> 
       <!--	Header start  -->
        ...
        <div class="full-row ">
            <div class="container ">
                ...
                <div class="row about-company">
                    ...
                    <div class="col-md-12 col-lg-5 mt-5 sec-4">
                        <div class="about-img"> <img class="aniG" src="admin/upload/<?php echo $row['3'];?>" alt="about image"> </div>
                    </div>
                </div>
        ...
        <!--	Our Partners --> 
        <?php include("include/ourpartners.php");?>
